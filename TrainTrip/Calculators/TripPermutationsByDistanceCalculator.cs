...
{
    public class TripStopPermutationsCalculator : ITripPermutationsCalculator
    {
        ...
        public TripStopPermutationsCalculator(IStationProvider stationProvider)
        {
        ...
        {
            if (currentTrip.TotalStops > maximum)
                return;
